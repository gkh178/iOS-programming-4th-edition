...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BNRCoursesViewController *cvc = [[BNRCoursesViewController alloc]init];
    
    //创建一个UINavigationController，将cvc作为它的根控制器
    UINavigationController *navigationController = [[UINavigationController alloc]initWithRootViewController:cvc];
    
    //创建一个BNRWebViewController，将其作为cvc的webViewController属性
