...
- (IBAction)addNewItem:(id)sender {
    ...
    navController.modalPresentationStyle = UIModalPresentationCurrentContext;//被显示的navController模态类型设置为自定义类型
    self.definesPresentationContext = YES;//BNRItemsTableView设为截断根视图作为被覆盖的下层，这里弹出的BNRItemsTableView不会覆盖navigationController
